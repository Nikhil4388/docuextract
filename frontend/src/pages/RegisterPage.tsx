  ...
  return (
    <Box sx={{
      ...
      <style>{`
        ...
        .register-wrap { animation: fadeUp 0.65s cubic-bezier(0.22,1,0.36,1) both; }
        .google-btn-outline {
      ...
      <Box className="register-wrap" sx={{
        width: '100%',
        maxWidth: 980,
        bgcolor: '#0c0c0c',
        ...
        <Box sx={{
          ...
          <Typography sx={{
            ...
            Create your<br />account in<br />seconds.
          </Typography>
        ...
        <Box sx={{
          ...
          <Typography sx={{
            fontSize: 28, fontWeight: 900, color: '#0c0c0c',
            letterSpacing: -0.8, mb: 1, lineHeight: 1.2,
          }}>
            Create your account
          </Typography>
          <Typography sx={{ fontSize: 14, color: '#64748b', mb: 3.5, lineHeight: 1.65 }}>
            Start extracting data from your PDFs for free.
          </Typography>
          ...
          <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: 1.8 }}>
            <TextField
              label="Full name (optional)" fullWidth size="small"
              value={fullName} onChange={(e) => setFullName(e.target.value)}
            />
            <TextField
              label="Email" type="email" fullWidth required size="small" autoFocus
            ...
            />
            <TextField
              label="Confirm password" type="password" fullWidth required size="small"
              value={confirm} onChange={(e) => setConfirm(e.target.value)}
            />
            <Button
              type="submit" fullWidth disabled={loading}
              sx={{
                py: 1.6, borderRadius: '14px', bgcolor: '#0c0c0c', color: 'white',
                fontWeight: 700, fontSize: 15, mt: 0.5,
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, my: 3 }}>
            ...
            <Typography sx={{ fontSize: 12, color: '#94a3b8', fontWeight: 600 }}>OR</Typography>
            <Box sx={{ flex: 1, height: '1px', bgcolor: 'rgba(0,0,0,0.1)' }} />
          </Box>
          ...
          <Typography sx={{ fontSize: 13.5, color: '#64748b', textAlign: 'center' }}>
            Already have an account?{' '}
            <Box component={Link} to="/login" sx={{ color: '#6366f1', fontWeight: 700, textDecoration: 'none' }}>
              Sign in
            </Box>
          </Typography>
        </Box>
